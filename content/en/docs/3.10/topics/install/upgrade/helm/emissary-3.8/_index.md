...
<Alert severity="info">
  This guide covers migrating from Emissary 3.8.Z to Emissary 3.10. If
...
1. **Install new CRDs.**
   ...
   in the previous version of Emissary and does not require the complex migration steps that the migration from 1.x to 2.x required.
