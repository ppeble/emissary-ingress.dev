...
This document describes the End of Life policy and maintenance windows for Ambassador Edge Stack, and to the open source project Emissary.

## Supported Versions

Ambassador Edge Stack and Emissary versions are expressed as **x.y.z**, where **x** is the major version, **y** is the minor version, and **z** is the patch version, following [Semantic Versioning](https://semver.org/) terminology.
...
- We will fix security issues in our Emissary and Ambassador Edge Stack code
