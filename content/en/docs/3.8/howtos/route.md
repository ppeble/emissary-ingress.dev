...
On the other hand, these URLs share only the prefix `/` -- you _could_ tell Emissary Ingress to treat them as a single resource, but it's probably not terribly useful.
