...
* `xff_num_trusted_hops` sets the default value for [the `l7Depth` setting of a `Listener`](../listener/#l7depth). The default is 0.

See the [`Listener` documentation](../listener/#l7depth) for more details.
