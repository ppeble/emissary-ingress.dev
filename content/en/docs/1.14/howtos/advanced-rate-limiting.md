...
Note for this to work, you need to make sure you've properly configured Ambassador Edge Stack to [propagate your original client IP address](../../topics/running/ambassador#trust-downstream-client-ip).
