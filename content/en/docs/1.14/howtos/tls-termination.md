...
**Note:** If running multiple instances of Emissary in one cluster remember to include ambassador_id property in the spec, must be an array of id(s).
...
With Emissary, this can be simply done by requesting a
