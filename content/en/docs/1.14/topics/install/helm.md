...
**Note:** If your existing installation is running $OSSproductName$, **do not use these instructions**. See [Migrating to Emissary](#migrating-to-aesproductname) instead.
