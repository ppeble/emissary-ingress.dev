...
Then, use the following command to upgrade the $OSSproductName$ installation to Emissary:
...
Once you’re satisfied with the new deployment, update your current $OSSproductName$ service to redirect traffic to Emissary.
